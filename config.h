...
static const char *fonts[]          = {  "GoMono Nerd Font:pixelsize=16:antialias=true:autohint=true"};
static const char dmenufont[]       = "GoMono Nerd Font:pixelsize=20:antialias=true:autohint=true";
...
static const Key keys[] = {
	...
	{ MODKEY,                            XK_Escape,                 spawn,               SHCMD("dunstctl close") }, //dunst
	{ MODKEY|ShiftMask,                  XK_Escape,                 spawn,               SHCMD("dunstctl close-all") }, //dunst
	{ MODKEY|ControlMask,                XK_Escape,                 spawn,               SHCMD("dunstctl history-pop") }, //dunst
...
static const Button buttons[] = {
	...
	{ ClkStatusText,        0,              Button4,        spawn,          SHCMD("$HOME/.local/scripts/dunst-volume.sh +5%") }, // volume scroll on status bar
	{ ClkStatusText,        0,              Button5,        spawn,          SHCMD("$HOME/.local/scripts/dunst-volume.sh -5%") }, // volume scroll on status bar
};
